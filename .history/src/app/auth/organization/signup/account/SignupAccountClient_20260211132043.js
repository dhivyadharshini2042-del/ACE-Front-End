...
export default function SignupAccountClient() {
  ...
  const handleEmailChange = (e) => {
    ...
    if (value.length <= 250) {
      ...
      setEmailError("Maximum 250 characters allowed.");
    }
  };
  ...
  async function onSubmit(e) {
    ...
    if (email.length > 250)
      return toast.error(MSG_ERR_FOF_CHAR_LIMIT_EXCEED);
          ...
          <form className="org-form" onSubmit={onSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                maxLength={250}
                onPaste={(e) => {
                  if (e.clipboardData.getData("text").length + email.length > 250) {
                    e.preventDefault();
                    setEmailError("Maximum 250 characters allowed.");
                  }
                }}
